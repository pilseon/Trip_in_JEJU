...
//
//                // 여러 Shopping 데이터 생성
//                createShoppingData("자매국수", "제주도의 대표 국수 맛집입니다.", imagePaths[0]);
//
//            } catch (IOException e) {
//                e.printStackTrace();
//            }
...
//    }
//
//    private void createShoppingData(String title, String description, String imagePath) throws IOException {
