        ...
        return args -> {
            try {
                ...
                String[] imagePaths = {
                        ...
                        "/app/resources/static/images/other/다짐 헬스.png",
                ...
                createOtherData("킹스짐","00:00","24:00", "제주도대표 보디빌더이자, 제32회 미스터제주 그랑프리 김기원 대표가 직접 운영하며, 자타공인 각 종목별 최고의 선생님들이 여러분을 기다리고 있습니다.\n" +
                ...
                createOtherData("유휘트니스","06:00","24:00", "제주 해머스트랭스 오피셜 센터\n" +
                ...
                createOtherData("제주 바닷가하우스 키즈 펜션","00:00","24:00", "전객실 리모델링 OPEN !\n" +
