    ...
    public ApplicationRunner init() {
        return args -> {
            try {
                ...
                createAttractionsData("루나폴","20:30","24:00", "루나폴은 12만평 규모의 나이트 디지털 테마파크 입니다. '예로부터 사람들은 달에 소원을 빌었고, 소원이 가득 쌓여 무거워진 달이 제주에 떨어졌다' 라는 스토리를 기반으로 밤길을 걸으며 즐기는 몰입형 체험 콘텐츠를 제공합니다. 루나폴만의 세계관과 제주의 청정자연, 최정상 실감미디어 기술력이 만난 루나폴 판타지를 즐겨보세요.","연중무휴",
