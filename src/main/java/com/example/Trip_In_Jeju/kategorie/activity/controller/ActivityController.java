...
public class ActivityController {
    ...
    public String list(
        ...
        activityListInitSesstion(params, request,session);
    ...
    void activityListInitSesstion(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session){
